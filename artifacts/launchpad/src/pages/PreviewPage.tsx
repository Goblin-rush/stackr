  ...
  return (
    <div className="min-h-screen bg-[hsl(200_8%_11%)] text-[hsl(0_0%_96%)] flex flex-col" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <div className="border-b border-[hsl(200_6%_22%)] bg-[hsl(200_8%_14%)]/80 h-7 overflow-hidden relative">
        <div className="absolute left-0 top-0 bottom-0 z-10 flex items-center px-3 bg-[hsl(200_8%_14%)] border-r border-[hsl(200_6%_22%)]">
          <span className="flex items-center gap-1.5 text-[10px] font-mono uppercase tracking-wider text-[hsl(200_5%_60%)]">
            <span className="h-1.5 w-1.5 bg-[hsl(166_75%_65%)] rounded-full animate-pulse" />
            Tape
          </span>
        </div>
        <div className="flex items-center gap-6 h-full pl-20 whitespace-nowrap" style={{ animation: 'tape 40s linear infinite' }}>
          {[...TAPE, ...TAPE].map((tr, i) => (
